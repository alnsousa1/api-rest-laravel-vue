...
<template>
    <div class="mt-12">
        <div class="flex justify-end m-2 p-2">
            <RouterLink :to="{ name: 'DevsCreate' }" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 text-white rounded">
                Novo Desenvolvedor</RouterLink>
        </div>
                ...
                <tbody>
                    <tr v-for="dev in devs" :key="dev.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="py-4 px-6 space-x-2 flex justify-end">
                            <RouterLink :to="{ name: 'DevsEdit', params: { id: dev.id } }"
